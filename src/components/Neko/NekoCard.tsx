...
export default function NekoCard({ image, priority }: NekoCardProps) {
  ...
  return (
    <>
      ...
      <div 
        ...
        className="group relative aspect-square w-full overflow-hidden rounded-2xl bg-gray-900 cursor-zoom-in border border-white/5 transition-all hover:border-blue-500/50 shadow-xl"
      >
        <img 
          src={image.url} 
          alt="Neko Asset"
      ...
      {isPreviewOpen && (
        ...
        >
          {/* KUNCI UTAMA: 
            Memberikan pt-32 (Padding Top) pada seluruh pembungkus konten 
            agar gambar dan teks dimulai dari bawah Navbar.
          */}
          <div className="flex-grow flex flex-col lg:flex-row pt-32 lg:pt-36 pb-10 overflow-hidden">
            ...
            <div className="flex-[1.5] h-full flex items-center justify-center p-4 md:p-12 relative overflow-hidden">
              <img 
                ...
                alt="Full View"
                /* KUNCI GAMBAR: 
                  Menggunakan object-contain agar gambar tidak pernah terpotong 
                  dan tetap proporsional meskipun layarnya sempit.
                */
            ...
            >
              <div className="space-y-10">
                <div>
                  ...
                  <h2 className="text-4xl md:text-5xl font-black italic text-white uppercase tracking-tighter leading-none mb-4">
                    Neural <span className="text-blue-600">Asset</span>
                  </h2>
                  <p className="text-gray-500 text-xs leading-relaxed italic opacity-70">
                    Neural data stream stable. Verified for high-fidelity rendering within Core Engine parameters.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-8 pt-8 border-t border-white/5">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm font-mono text-gray-200">NEKO_SYS_01</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-[9px] text-gray-600 uppercase font-bold tracking-[0.2em]">Type</p>
                    <p className="text-sm font-mono text-gray-200">IMG/PNG</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-[9px] text-gray-600 uppercase font-bold tracking-[0.2em]">Format</p>
                    <p className="text-sm font-mono text-gray-200">RASTER</p>
                  </div>
                </div>
                ...
                <div className="pt-8">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['SFW', 'COLLECTIBLE', 'NEURAL_HD'].map(tag => (
              ...
              <div className="space-y-4 pt-12 border-t border-white/5 mt-10">
                ...
                >
                  {isDownloading ? 'Syncing...' : 'Download Neural Asset'}
                </button>
                <button 
                  onClick={() => setIsPreviewOpen(false)}
